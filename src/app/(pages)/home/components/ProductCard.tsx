...
const ProductCard = ({ title, price, store, negotiable = false, onClick }: ProductCardProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="px-3 pt-2.5 pb-3">
                <p className="text-text-primary text-xs font-medium leading-tight mb-1.5">{title}</p>
                <div className="flex items-center gap-2 mb-2">
                    <span className="text-text-primary text-sm font-bold tracking-tight">{price}</span>
                    {negotiable && (
