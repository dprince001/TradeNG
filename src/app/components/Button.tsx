...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary: "bg-gray-100 text-text-primary hover:bg-gray-200/80 active:bg-gray-200",
      outline: "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 active:bg-gray-100",
      "brand-outline": "bg-white border-2 border-primary text-primary hover:bg-[#FFF5F3]/50 font-bold",
      destructive: "bg-red-600 text-white hover:bg-red-700 shadow-sm active:bg-red-800",
      "destructive-outline": "bg-white border border-red-500 text-red-500 hover:bg-red-50 font-bold",
